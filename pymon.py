...
class PyMon:
    ...
    def get_code_list(self):
        ...
        self.kosdaq_codes = self.kosdaq_codes[:100]

    def get_ohlcv(self, code, start):
        self.kiwoom.ohlcv = {'date': [], 'open': [], 'high': [], 'low': [],
                             'close': [], 'volume': []}
    ...
    def update_buy_list(self, buy_list):
        f = open("C:/Users/USER/PycharmProjects/unmaker/buy_list.txt", "wt")
    ...
    def get_min_max_dividend_to_treasury(self, code):
        ...
        if len(previous_dividend_yield)==0:
            min_ratio=0
            max_ratio=0
        else:
    ...
    def run_dividend(self):
        ...
        for code in self.kospi_codes[:50]:
            time.sleep(0.5)
